YUI().use('event-focus', 'json', 'model', 'model-list', 'view', 'datatable', function (Y) {
    var TodoAppView, TodoList, TodoModel, TodoView, TodoAppViewDT;
...
TodoAppViewDT = Y.TodoAppViewDT = Y.Base.create('todoAppViewDT', Y.View, [], {
    ...
    template: Y.one('#todo-item-template-dt').getHTML(),
    ...
    render: function () {
        ...
        // stats.setHTML(table.render('#todo-stats'));
        table.data.load(function () {
                            table.render('#todo-stats');
                        });
